...
// NewEvaluacion1Parser produces a new parser instance for the optional input antlr.TokenStream.
//
// The *Evaluacion1Parser instance produced may be reused by calling the SetInputStream method.
...
func (s *InicioContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
...
func (s *DosNumeroContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterDosNumero(s)
	}
}

func (s *DosNumeroContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitDosNumero(s)
	}
}
...
func (s *HTPTContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterHTPT(s)
	}
}

func (s *HTPTContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitHTPT(s)
	}
}
...
func (s *HTContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterHT(s)
	}
}

func (s *HTContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitHT(s)
	}
}
...
func (s *THexContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterTHex(s)
	}
}

func (s *THexContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitTHex(s)
	}
}
...
func (s *EpTpContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterEpTp(s)
	}
}

func (s *EpTpContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitEpTp(s)
	}
}
...
func (s *TpHexContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.EnterTpHex(s)
	}
}

func (s *TpHexContext) ExitRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(Evaluacion1Listener); ok {
		listenerT.ExitTpHex(s)
	}
}
