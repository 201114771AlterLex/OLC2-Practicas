...
type Practica3_copyLexer struct {
	*antlr.BaseLexer
	channelNames []string
	modeNames    []string
	// TODO: EOF string
...
func NewPractica3_copyLexer(input antlr.CharStream) *Practica3_copyLexer {

	l := new(Practica3_copyLexer)
...
// Practica3_copyLexer tokens.
const (
	Practica3_copyLexerPRight     = 1
	Practica3_copyLexerPLeft      = 2
	Practica3_copyLexerPlus       = 3
	Practica3_copyLexerTimes      = 4
	Practica3_copyLexerPoint      = 5
	Practica3_copyLexerNumbers    = 6
	Practica3_copyLexerDecimal    = 7
	Practica3_copyLexerWhitespace = 8
)
